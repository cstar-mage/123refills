...
<?php 
class Varien_Data_Form_Element_Gallery16 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
            ...
            $query = "SELECT * FROM ".$table_name." WHERE `shape` = 'Cushion' ";
           ...
           $caratweightJson = json_encode($caratweight);
            ...
            $html = "<input type='hidden' value='".$caratrowcount."' id='cushioncount' name='cushioncount' />
                <table width='100%' id='cushiontable'>
            ...
            foreach ($newArray as $caratkey => $caratarray) {
                ...
                $html .= "<tr id='cushion-row-".$i."'>
                                             <td><p class='caratvalue'>".$caratkey."</p><input type='hidden' class='validate-number' name='cushion-".$i."[]' value=".$caratkey." /><input type='hidden' name='cushion-".$i."[]' value='cushion' />                         
                         </td>";
                $a=0;
                $columncount = 2;
                ...
                foreach($caratarray as $key => $value){             
                    ...
                    $key1 = array_search($value['dbfield'],$k3);
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='cushion-".$i."[]' value=".$value['price']." />                       
                        <input type='hidden' name='cushion-".$i."[]' value=".$value['diamondstud_id']." />
                        <input type='hidden' name='cushion-".$i."[]' value=".$value['dbfield']." />
                        </td>";
                ...
                if($a != $rowcount){
                    ...
                    $p--;
                     ...
                     for($n=0;$n<$remainrow;$n++){
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='cushion-".$i."[]' value='' /><input type='hidden' name='cushion-".$i."[]' value='' />
                        <input type='hidden' name='cushion-".$i."[]' value='".$hhh[$n]."' />
                        </td>";
       ...
       $html .= '<thead id="gallery_thead_2" class="gallery"></thead>';
        ...
        var caratfinalcushion = caratarray.filter(function(val) {return caratexist1.indexOf(val) == -1;});

            


        var caratfcountcushion = caratfinalcushion.length;
              
        catarray = catarray.reverse();

        cushionid2 = $caratrowcount+1; 
        ...
        var table = document.getElementById("cushiontable");
        document.getElementById("cushioncount").value = cushionid2;
        var row = table.insertRow(cushionid2);
        row.id = 'cushion-row-'+ cushionid2;
        ...
        for(j=rowid;j>=1;j--){
           ...
           if(j==1){
            ...
            for(k=0;k<caratfcountcushion;k++){
                aaa += "<option value="+caratfinalcushion[k]+">"+caratfinalcushion[k]+"</option>";  
            }
          
             cell1.innerHTML = "<select style='width:157px' name='cushion-"+cushionid2+"[]'>"+aaa+"</select><input type='hidden' value='cushion' name='cushion-"+cushionid2+"[]'/>";
        //    cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='cushion-"+cushionid2+"[]'/><input type='hidden' value='cushion' name='cushion-"+cushionid2+"[]'/>"; 

           }else{

            var cell1 = 'cell'+j;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='cushion-"+cushionid2+"[]'/><input type='hidden' name='cushion-"+cushionid2+"[]'/><input type='hidden' value='"+catarray[t]+"' name='cushion-"+cushionid2+"[]'/>"; 
            t++;
           }
