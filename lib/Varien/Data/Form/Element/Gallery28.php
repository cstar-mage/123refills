...
<?php 
class Varien_Data_Form_Element_Gallery28 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
            ...
            $query = "SELECT * FROM ".$table_name." WHERE `shape` = 'SquareRadiant' ";
           ...
           $caratweightJson = json_encode($caratweight);
            ...
            $html = "<input type='hidden' value='".$caratrowcount."' id='SquareRadiantcount' name='SquareRadiantcount' />
                <table width='100%' id='SquareRadianttable'>
            ...
            foreach ($newArray as $caratkey => $caratarray) {
                ...
                $html .= "<tr id='SquareRadiant-row-".$i."'>
                                             <td><p class='caratvalue'>".$caratkey."</p><input type='hidden' class='validate-number' name='SquareRadiant-".$i."[]' value=".$caratkey." /><input type='hidden' name='SquareRadiant-".$i."[]' value='SquareRadiant' />                         
                         </td>";
                $a=0;
                $columncount = 2;
                ...
                foreach($caratarray as $key => $value){             
                    ...
                    $key1 = array_search($value['dbfield'],$k3);
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='SquareRadiant-".$i."[]' value=".$value['price']." />                       
                        <input type='hidden' name='SquareRadiant-".$i."[]' value=".$value['diamondstud_id']." />
                        <input type='hidden' name='SquareRadiant-".$i."[]' value=".$value['dbfield']." />
                        </td>";
                ...
                if($a != $rowcount){
                    ...
                    $p--;
                     ...
                     for($n=0;$n<$remainrow;$n++){
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='SquareRadiant-".$i."[]' value='' /><input type='hidden' name='SquareRadiant-".$i."[]' value='' />
                        <input type='hidden' name='SquareRadiant-".$i."[]' value='".$hhh[$n]."' />
                        </td>";
       ...
       $html .= '<thead id="gallery_thead_2" class="gallery"></thead>';
        ...
        $buttonHtml = $widgetButton->createBlock('adminhtml/widget_button')
                ->setData(
                    array(
                        'label'     => 'Add SquareRadiant Price',
                        'onclick'   => 'addSquareRadiant()',
                        'class'     => 'add'))
                ->toHtml();
        ...
        var caratfinalSquareRadiant = caratarray.filter(function(val) {return caratexist1.indexOf(val) == -1;});

            


        var caratfcountSquareRadiant = caratfinalSquareRadiant.length;
              
        catarray = catarray.reverse();

        SquareRadiantid2 = $caratrowcount+1; 
        ...
        function addSquareRadiant(){
        
        var table = document.getElementById("SquareRadianttable");
        document.getElementById("SquareRadiantcount").value = SquareRadiantid2;
        var row = table.insertRow(SquareRadiantid2);
        row.id = 'SquareRadiant-row-'+ SquareRadiantid2;
        ...
        for(j=rowid;j>=1;j--){
           ...
           if(j==1){
            ...
            for(k=0;k<caratfcountSquareRadiant;k++){
                aaa += "<option value="+caratfinalSquareRadiant[k]+">"+caratfinalSquareRadiant[k]+"</option>";  
            }
          
             cell1.innerHTML = "<select style='width:157px' name='SquareRadiant-"+SquareRadiantid2+"[]'>"+aaa+"</select><input type='hidden' value='SquareRadiant' name='SquareRadiant-"+SquareRadiantid2+"[]'/>";
        //    cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='SquareRadiant-"+SquareRadiantid2+"[]'/><input type='hidden' value='SquareRadiant' name='SquareRadiant-"+SquareRadiantid2+"[]'/>"; 

           }else{

            var cell1 = 'cell'+j;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='SquareRadiant-"+SquareRadiantid2+"[]'/><input type='hidden' name='SquareRadiant-"+SquareRadiantid2+"[]'/><input type='hidden' value='"+catarray[t]+"' name='SquareRadiant-"+SquareRadiantid2+"[]'/>"; 
            t++;
           }
