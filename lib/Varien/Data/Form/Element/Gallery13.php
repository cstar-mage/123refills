...
<?php 
class Varien_Data_Form_Element_Gallery13 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
            ...
            $query = "SELECT * FROM ".$table_name." WHERE `shape` = 'Princess' ";
           ...
           $caratweightJson = json_encode($caratweight);
            ...
            $html = "<input type='hidden' value='".$caratrowcount."' id='princesscount' name='princesscount' />
                <table width='100%' id='princesstable'>
            ...
            foreach ($newArray as $caratkey => $caratarray) {
                ...
                $html .= "<tr id='princess-row-".$i."'>
                                         <td><p class='caratvalue'>".$caratkey."</p><input type='hidden' class='validate-number' name='princess-".$i."[]' value=".$caratkey." /><input type='hidden' name='princess-".$i."[]' value='princess' />                         
                         </td>";
                $a=0;
                $columncount = 2;
                ...
                foreach($caratarray as $key => $value){             
                    ...
                    $key1 = array_search($value['dbfield'],$k3);
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='princess-".$i."[]' value=".$value['price']." />                       
                        <input type='hidden' name='princess-".$i."[]' value=".$value['diamondstud_id']." />
                        <input type='hidden' name='princess-".$i."[]' value=".$value['dbfield']." />
                        </td>";
                ...
                if($a != $rowcount){
                    ...
                    $p--;
                     ...
                     for($n=0;$n<$remainrow;$n++){
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='princess-".$i."[]' value='' /><input type='hidden' name='princess-".$i."[]' value='' />
                        <input type='hidden' name='princess-".$i."[]' value='".$hhh[$n]."' />
                        </td>";
       ...
       $html .= '<thead id="gallery_thead_2" class="gallery"></thead>';
        ...
        var caratfinalprincess = caratarray.filter(function(val) {return caratexist1.indexOf(val) == -1;});

            


        var caratfcountprincess = caratfinalprincess.length;
              
        catarray = catarray.reverse();

        princessid2 = $caratrowcount+1; 
        ...
        var table = document.getElementById("princesstable");
        document.getElementById("princesscount").value = princessid2;
        var row = table.insertRow(princessid2);
        row.id = 'princess-row-'+ princessid2;
        ...
        for(j=rowid;j>=1;j--){
           ...
           if(j==1){
            ...
            for(k=0;k<caratfcountprincess;k++){
                aaa += "<option value="+caratfinalprincess[k]+">"+caratfinalprincess[k]+"</option>";  
            }
          
             cell1.innerHTML = "<select style='width:157px' name='princess-"+princessid2+"[]'>"+aaa+"</select><input type='hidden' value='princess' name='princess-"+princessid2+"[]'/>";
        //    cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='princess-"+princessid2+"[]'/><input type='hidden' value='princess' name='princess-"+princessid2+"[]'/>"; 

           }else{

            var cell1 = 'cell'+j;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='princess-"+princessid2+"[]'/><input type='hidden' name='princess-"+princessid2+"[]'/><input type='hidden' value='"+catarray[t]+"' name='princess-"+princessid2+"[]'/>"; 
            t++;
           }
