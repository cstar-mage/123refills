...
class Varien_Data_Form_Element_Gallery2 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        $gallery = $this->getValue();
			...
			$magento_db = Mage::getStoreConfig('uploadtool/db_detail/db_database'); 
			$mdb_user = Mage::getStoreConfig('uploadtool/db_detail/db_username');
			$mdb_passwd = Mage::getStoreConfig('uploadtool/db_detail/db_userpassword');
			$mdb_name = Mage::getStoreConfig('uploadtool/db_detail/db_name');
...
$count = count($rap_percent);
		...
		<td><input type='text' name='vendor_2-".$i."' value=".$vendor_id[$i]." /></td></tr>";
        	...
        	$html .= "<tr id='vendor-row-".$i."'>
        	<td><input type='text' name='vendor_1-".$i."' value=".$vendor_name[$i]." /></td></tr>";
        	}
		...
		<td><input name='vendor_2-".$j."'  /></td></tr>";
        	...
        	$html .= "<tr id='vendor-row-".$j."' class='no-display'>
        	<td><input name='vendor_1-".$j."'  /></td></tr>";
        	}
        ...
        $html .= '<thead id="gallery_thead_2" class="gallery"><tr class="gallery"><td class="gallery" valign="middle" align="center">Vendor Name</td><td class="gallery" valign="middle" align="center">% Rap</td><td class="gallery" valign="middle" align="center">Sort Order</td><td class="gallery" valign="middle" align="center">Delete</td></tr></thead>';
