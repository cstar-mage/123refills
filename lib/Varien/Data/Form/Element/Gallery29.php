...
<?php 
class Varien_Data_Form_Element_Gallery29 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
            ...
            $query = "SELECT * FROM ".$table_name." WHERE `shape` = 'Fancy' ";
           ...
           $caratweightJson = json_encode($caratweight);
            ...
            $html = "<input type='hidden' value='".$caratrowcount."' id='fancycount' name='fancycount' />
                <table width='100%' id='fancytable'>
            ...
            foreach ($newArray as $caratkey => $caratarray) {
                ...
                $html .= "<tr id='fancy-row-".$i."'>
                                             <td><p class='caratvalue'>".$caratkey."</p><input type='hidden' class='validate-number' name='fancy-".$i."[]' value=".$caratkey." /><input type='hidden' name='fancy-".$i."[]' value='fancy' />                         
                         </td>";
                $a=0;
                $columncount = 2;
                ...
                foreach($caratarray as $key => $value){             
                    ...
                    $key1 = array_search($value['dbfield'],$k3);
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='fancy-".$i."[]' value=".$value['price']." />                       
                        <input type='hidden' name='fancy-".$i."[]' value=".$value['diamondstud_id']." />
                        <input type='hidden' name='fancy-".$i."[]' value=".$value['dbfield']." />
                        </td>";
                ...
                if($a != $rowcount){
                    ...
                    $p--;
                     ...
                     for($n=0;$n<$remainrow;$n++){
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='fancy-".$i."[]' value='' /><input type='hidden' name='fancy-".$i."[]' value='' />
                        <input type='hidden' name='fancy-".$i."[]' value='".$hhh[$n]."' />
                        </td>";
       ...
       $html .= '<thead id="gallery_thead_2" class="gallery"></thead>';
        ...
        var caratfinalfancy = caratarray.filter(function(val) {return caratexist1.indexOf(val) == -1;});

            


        var caratfcountfancy = caratfinalfancy.length;
              
        catarray = catarray.reverse();

        fancyid2 = $caratrowcount+1; 
        ...
        document.getElementById("fancycount").value = fancyid2;
        var row = table.insertRow(fancyid2);
        row.id = 'fancy-row-'+ fancyid2;
        ...
        for(j=rowid;j>=1;j--){
           ...
           if(j==1){
            ...
            for(k=0;k<caratfcountfancy;k++){
                aaa += "<option value="+caratfinalfancy[k]+">"+caratfinalfancy[k]+"</option>";  
            }
          
             cell1.innerHTML = "<select style='width:157px' name='fancy-"+fancyid2+"[]'>"+aaa+"</select><input type='hidden' value='fancy' name='fancy-"+fancyid2+"[]'/>";
        //    cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='fancy-"+fancyid2+"[]'/><input type='hidden' value='fancy' name='fancy-"+fancyid2+"[]'/>"; 

           }else{

            var cell1 = 'cell'+j;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='fancy-"+fancyid2+"[]'/><input type='hidden' name='fancy-"+fancyid2+"[]'/><input type='hidden' value='"+catarray[t]+"' name='fancy-"+fancyid2+"[]'/>"; 
            t++;
           }
