...
<?php 
class Varien_Data_Form_Element_Gallery14 extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
            ...
            $query = "SELECT * FROM ".$table_name." WHERE `shape` = 'Emerald' ";
           ...
           $caratweightJson = json_encode($caratweight);
            ...
            $html = "<input type='hidden' value='".$caratrowcount."' id='emeraldcount' name='emeraldcount' />
                <table width='100%' id='emeraldtable'>
            ...
            foreach ($newArray as $caratkey => $caratarray) {
                ...
                $html .= "<tr id='emerald-row-".$i."'>
                                     <td><p class='caratvalue'>".$caratkey."</p><input type='hidden' class='validate-number' name='emerald-".$i."[]' value=".$caratkey." /><input type='hidden' name='emerald-".$i."[]' value='emerald' />                         
                         </td>";
                $a=0;
                $columncount = 2;
                ...
                foreach($caratarray as $key => $value){             
                    ...
                    $key1 = array_search($value['dbfield'],$k3);
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='emerald-".$i."[]' value=".$value['price']." />                       
                        <input type='hidden' name='emerald-".$i."[]' value=".$value['diamondstud_id']." />
                        <input type='hidden' name='emerald-".$i."[]' value=".$value['dbfield']." />
                        </td>";
                ...
                if($a != $rowcount){
                    ...
                    $p--;
                     ...
                     for($n=0;$n<$remainrow;$n++){
                        ...
                        $html .= "<td><input type='text' class='validate-number required-entry' name='emerald-".$i."[]' value='' /><input type='hidden' name='emerald-".$i."[]' value='' />
                        <input type='hidden' name='emerald-".$i."[]' value='".$hhh[$n]."' />
                        </td>";
       ...
       $html .= '<thead id="gallery_thead_2" class="gallery"></thead>';
        ...
        var caratfinalemerald = caratarray.filter(function(val) {return caratexist1.indexOf(val) == -1;});

        var caratfcountemerald = caratfinalemerald.length;
              
        catarray = catarray.reverse();

        emeraldid2 = $caratrowcount+1; 
        ...
        var table = document.getElementById("emeraldtable");
        document.getElementById("emeraldcount").value = emeraldid2;
        var row = table.insertRow(emeraldid2);
        row.id = 'emerald-row-'+ emeraldid2;
        ...
        for(j=rowid;j>=1;j--){
           ...
           if(j==1){
            ...
            for(k=0;k<caratfcountemerald;k++){
                aaa += "<option value="+caratfinalemerald[k]+">"+caratfinalemerald[k]+"</option>";  
            }
          
             cell1.innerHTML = "<select style='width:157px' name='emerald-"+emeraldid2+"[]'>"+aaa+"</select><input type='hidden' value='emerald' name='emerald-"+emeraldid2+"[]'/>";
        //    cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='emerald-"+emeraldid2+"[]'/><input type='hidden' value='emerald' name='emerald-"+emeraldid2+"[]'/>"; 

           }else{

            var cell1 = 'cell'+j;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = "<input type='text' class='validate-number required-entry' name='emerald-"+emeraldid2+"[]'/><input type='hidden' name='emerald-"+emeraldid2+"[]'/><input type='hidden' value='"+catarray[t]+"' name='emerald-"+emeraldid2+"[]'/>"; 
            t++;
           }
