...
class Netzarbeiter_CustomerActivation_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    protected function _sendNotificationEmail($to, $customer, $templateConfigPath, $storeId = null)
    {
        ...
        $logo->setImgsrc(str_replace("base",Mage::getStoreConfig('design/package/name',1),Mage::getDesign()->getSkinUrl(Mage::getStoreConfig('design/header/logo_src'),array('_area'=>'frontend'))));
        $logo->setAlt(Mage::getStoreConfig('general/store_information/name'));
