...
//exit;
      ...
      $data['featured_image'] = 'blog'.DS.$_FILES['featured_image']['name'];
...
// handle delete image
   ...
   if(isset($data['featured_image']['delete']) && $data['featured_image']['delete'] == 1) { //echo "adsasd set";
      $data['image_main'] = '';
   }
   else { //echo "adsasd unset";
