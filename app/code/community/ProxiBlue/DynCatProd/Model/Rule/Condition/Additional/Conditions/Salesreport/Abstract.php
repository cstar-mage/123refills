 ...
 */
class ProxiBlue_DynCatProd_Model_Rule_Condition_Additional_Conditions_Salesreport_Abstract
    extends
    ProxiBlue_DynCatProd_Model_Rule_Condition_Additional_Conditions_Abstract
{
    ...
    public function mergeCollections($productCollection, $salesCollection)
    {
        ...
        $productSelect->setPart(
            Zend_Db_Select::COLUMNS, array(array('e', 'entity_id', null))
        );
        // do we have a limiter? Older versions of mysql do not support
        // limit in subquery
    ...
    /**
     * validate wrapper
     * Sets the sales report category flag to not allow positions to be set
     * manually
     *
