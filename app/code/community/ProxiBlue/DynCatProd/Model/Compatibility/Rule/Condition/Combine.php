 ...
 *
 * This is essentially the core file Mage_Rule_Model_Condition_Combine from 1.9.1.0
 */

class ProxiBlue_DynCatProd_Model_Compatibility_Rule_Condition_Combine
    extends ProxiBlue_DynCatProd_Model_Compatibility_Rule_Condition_Abstract
{
    /**
