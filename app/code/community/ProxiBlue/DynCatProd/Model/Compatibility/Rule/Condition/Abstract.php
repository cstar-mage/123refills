<?php
/**
 * Incorporated into module as older version of magento no longer worked
 *
 * This ensures I use the same code in all magento versions, thus compatibility increases as I no longer have to
 * contend with core changes.
 *
 * This is an initial step to solve compatibility issue, and requires refactoring
 *
 * This is essentially the core file Mage_Rule_Model_Condition_Abstract from 1.9.1.0
 */
abstract class ProxiBlue_DynCatProd_Model_Compatibility_Rule_Condition_Abstract
    extends Varien_Object
    implements ProxiBlue_DynCatProd_Model_Compatibility_Rule_Condition_Interface
{
    /**
