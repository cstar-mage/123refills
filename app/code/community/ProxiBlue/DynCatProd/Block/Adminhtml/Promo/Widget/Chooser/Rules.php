 ...
 */
class ProxiBlue_DynCatProd_Block_Adminhtml_Promo_Widget_Chooser_Rules
    extends Mage_Adminhtml_Block_Widget_Grid
{
        ...
        if ($column->getId() == 'in_rules') {
            ...
            if ($column->getFilter()->getValue()) {
                $this->getCollection()->addFieldToFilter(
                    'rule_id', array('in' => $selected)
                );
            } else {
                $this->getCollection()->addFieldToFilter(
                    'rule_id', array('nin' => $selected)
                );
            }
        } else {
    ...
    /**
     * Prepare Catalog Product Collection for attribute SKU in Promo Conditions
     * SKU chooser
     *
