<?php
include_once('Mage/Newsletter/controllers/SubscriberController.php');class ES_Newssubscribers_SubscriberController extends Mage_Newsletter_SubscriberController
