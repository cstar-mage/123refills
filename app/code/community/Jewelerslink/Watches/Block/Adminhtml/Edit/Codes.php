 ...
 */
class Jewelerslink_Watches_Block_Adminhtml_Edit_Codes extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $url = $this->getUrl('adminhtml/watches_codes_grid/saveForm', array('code_id' => $this->getRequest()->getParam('code_id')));
    ...
    public function getHeaderText()
    {
    	if( Mage::registry('codes_data') && Mage::registry('codes_data')->getId() ) {
    		return Mage::helper('watches')->__('Update attribute map');
    	} else {
    		return Mage::helper('watches')->__('Import attribute map');
    	}
    }
}
