...
class Webshopapps_Matrixrate_Block_Adminhtml_Shipping_Carrier_Matrixrate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  /**
    ...
    protected function _prepareColumns()
    {
        ...
        //$label = Mage::getSingleton('matrixrate/carrier_matrixrate')->getCode('condition_name_short', $this->getConditionName());
        $label = "Price/Weight"; // combined label
        ...
        $this->addColumn('condition_type', array(
        		'header'    => Mage::helper('adminhtml')->__('Condition Type'),
        		'index'     => 'condition_type',
        ));
        
        $this->addColumn('ship_code', array(
        		'header'    => Mage::helper('adminhtml')->__('Ship Code'),
        		'index'     => 'ship_code',
        ));
   ...
   protected function _prepareCollection()
    {
        ...
        //$collection->setConditionFilter($this->getConditionName()); // removed condition filter as we need both conditions
