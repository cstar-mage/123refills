...
class Magebuzz_Testimonial_Block_Adminhtml_Testimonial_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        //http://production.idealbrandmarketing.com/task_detail.php?ti=13831 Please add an entry field in the back-end for "Date" for the testimonials and use that date for the date on pink banner. 
        $fieldset->addField('testimonial_date', 'date', array(
        		'label'     => Mage::helper('testimonial')->__('Testimonial Date'),
        		'required'  => false,
