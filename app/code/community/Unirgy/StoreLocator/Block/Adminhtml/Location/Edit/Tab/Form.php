...
class Unirgy_StoreLocator_Block_Adminhtml_Location_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('notes', 'textarea', array(
		 ...
		 $fieldset->addField('store_name', 'multiselect', array(
          'label'     => Mage::helper('ustorelocator')->__('Select Store'),
          'name'      => 'store_name',
          'values'    => array(
              array(
                  'value'     => 'Store1',
                  'label'     => Mage::helper('ustorelocator')->__('Store1'),
              ),

              array(
                  'value'     => 'Store2',
                  'label'     => Mage::helper('ustorelocator')->__('Store2'),
              ),
          ),
        ));
