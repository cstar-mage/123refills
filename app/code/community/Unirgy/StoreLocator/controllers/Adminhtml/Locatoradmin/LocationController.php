 ...
 */
class Unirgy_StoreLocator_Adminhtml_Locatoradmin_LocationController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        if ( $this->getRequest()->getPost() ) {
            try {
            	if(count($this->getRequest()->getParam('store_name')) > 0){
            		$data['store_name'] = implode(',',$this->getRequest()->getParam('store_name'));
            	}else{
            		$data['store_name'] = '';
            	}
            	//print_r($this->getRequest()->getParam('store_name'));
            	//exit;
