	...
	public function getHtml()
	{
		...
		$defaultconfigarr = array(''=>'Please Select','enable'=>'Enable','disable'=>'Disable');
			$str = $str . '<tr style="display: table-row;">';
				$str = $str . '<td class="label"><label for="default_config">Default Config:</label></td>';
      			$str = $str . '<td class="value">';
      				$str = $str . '<select id="contacts_default_config" name="contacts_default_config" onChange="contactsdefaultconfig_fn(this.value);" >';
			...
			$str = $str . '<tr style="display: table-row;">';
				...
				$str = $str . '<td class="value">';
					$str = $str . '<input type="text" class=" input-text" value="'.$contactsdefaultconfigdata['contacts_title'].'" name="contacts_title" id="contacts_title">';
				$str = $str . '</td>';
			$str = $str . '</tr>';
			...
			$str = $str . '<tr style="display: table-row;">';
				...
				$str = $str . '<td class="value">';
					$str = $str . '<input type="text" class=" input-text" value="'.$contactsdefaultconfigdata['contacts_meta_description'].'" name="contacts_meta_description" id="contacts_meta_description">';
				$str = $str . '</td>';
			$str = $str . '</tr>';
