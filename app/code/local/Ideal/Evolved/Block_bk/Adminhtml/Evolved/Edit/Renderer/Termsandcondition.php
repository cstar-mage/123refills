...
jq(window).load(function(){
	jq("#addnewtermsandcondition").click(function(){
		...
		str1 += '<td class="label"><input type="hidden" class=" input-text" value="'+ lenght + '" name="termsandcondition_form_' + lenght + '_id" id="termsandcondition_form_' + lenght + '_id"><label for="termsandcondition_form_' + lenght + '_sort_order_label" style="margin-bottom: 10px; width: 110px;">Sort Order</label>';
		str1 += '<input type="text" class=" input-text" value="" name="termsandcondition_form_' + lenght + '_sort_order" id="termsandcondition_form_' + lenght + '_sort_order">';
		str1 += '</td>';
		str1 += '<td class="value">';
		...
		str1 += '<input type="text" class=" input-text" value="" name="termsandcondition_form_' + lenght + '_title" id="termsandcondition_form_' + lenght + '_title">';
		str1 += '</td>';
		str1 += '<td class="label">';
		...
		str1 += '<button class="scalable delete termsandcondition_delete" type="button" name="termsandcondition_form_' + lenght + '_delete" title="Delete" id="termsandcondition_form_' + lenght + '_delete" onclick=javascript:delete_fn("termsandcondition_form_' + lenght + '")><span><span><span>Delete</span></span></span></button>';
		str1 += '</td>';
		str1 += '</tr>';
		str1 += '<tr>';
		...
		str1 += '<textarea class=" textarea" cols="15" rows="2" name="termsandcondition_form_' + lenght + '_description" id="termsandcondition_form_' + lenght + '_description" style="height: 150px; width: 560px; "></textarea>';
		str1 += '</td>';
		str1 += '</tr>';
		str1 += '</tbody>';
		str1 += '</table>';
...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Renderer_Termsandcondition extends Varien_Data_Form_Element_Text
{
	...
	public function getHtml()
    {
    	...
    	$html .= '<tr>';
    	$html .= '<td>';
    	$html .= '<input type="hidden" name="termsandcondition_hidden" value="1">';
    	//$html .= '<input type="button" name="addnewtermsandcondition" id="addnewtermsandcondition" value="Add New" />';
    	$html .= '<button style="" onclick="" class="scalable add" type="button" name="addnewtermsandcondition" title="Add New Terms and Conditions" id="addnewtermsandcondition"><span><span><span>Add New</span></span></span></button>';
    	$html .= '</td>';
    	$html .= '</tr>';
    	$html .= '</tbody>';
    	$html .= '</table>';
    	...
    	for($count = 1; $count <= $lastrow[2]; $count++)
    	{
    		...
    		$html .= '<td class="label"><input type="hidden" class=" input-text" value="'.$termsandcondition_form_id.'" name="termsandcondition_form_'.$count.'_id" id="termsandcondition_form_'.$count.'_id"><label for="termsandcondition_form_'.$count.'_sort_order_label" style="margin-bottom: 10px; width: 110px;">Sort Order</label>';
    		$html .= '<input type="text" class=" input-text" value="'.$termsandcondition_form_sort_order.'" name="termsandcondition_form_'.$count.'_sort_order" id="termsandcondition_form_'.$count.'_sort_order">';
    		$html .= '</td>';
    		$html .= '<td class="value">';
    		$html .= '<label for="termsandcondition_form_'.$count.'_title_label" style="margin-bottom: 10px; width: 110px; display: block;">Title</label>';
    		$html .= '<input type="text" class=" input-text" value="'.$termsandcondition_form_title.'" name="termsandcondition_form_'.$count.'_title" id="termsandcondition_form_'.$count.'_title">';
    		$html .= '</td>';
    		$html .= '<td class="label">';
    		...
    		$html .= '<button class="scalable delete termsandcondition_delete" type="button" name="termsandcondition_form_'.$count.'_delete" title="Delete" id="termsandcondition_form_'.$count.'_delete" onclick=javascript:delete_fn("termsandcondition_form_'.$count.'")><span><span><span>Delete</span></span></span></button>';
    		$html .= '</td>';
    		$html .= '</tr>';
    		$html .= '<tr>';
    		...
    		$html .= '<textarea class=" textarea" cols="15" rows="2" name="termsandcondition_form_'.$count.'_description" id="termsandcondition_form_'.$count.'_description" style="height: 150px; width: 560px; ">'.$termsandcondition_form_description.'</textarea>';
    		$html .= '</td>';
    		$html .= '</tr>';
    		$html .= '</tbody>';
    		$html .= '</table>';
