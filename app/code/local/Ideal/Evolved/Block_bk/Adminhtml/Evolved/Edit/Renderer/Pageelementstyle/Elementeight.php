    			...
    			//if($selectElement == '1920_by_480_banner')
	      				{
							...
							$str = $str . '<tbody>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_one_style_title"  value="'.$collectiondata['homepage_element_8_one_style_title'].'"  name="homepage_element_8_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_one_style_link" value="'.$collectiondata['homepage_element_8_one_style_link'].'" name="homepage_element_8_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';      						
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_one_style_target" name="homepage_element_8_one_style_target" >';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_one_mobile_style_title"  value="'.$collectiondata['homepage_element_8_one_mobile_style_title'].'"  name="homepage_element_8_one_mobile_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_one_mobile_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_one_mobile_style_link" value="'.$collectiondata['homepage_element_8_one_mobile_style_link'].'" name="homepage_element_8_one_mobile_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_one_mobile_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_one_mobile_style_target" name="homepage_element_8_one_mobile_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '1920_by_800_banner')
	      				{
							...
							$str = $str . '<tbody>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_two_style_title" value="'.$collectiondata['homepage_element_8_two_style_title'].'"  name="homepage_element_8_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_two_style_link" value="'.$collectiondata['homepage_element_8_two_style_link'].'" name="homepage_element_8_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_two_style_target" name="homepage_element_8_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_two_mobile_style_title"  value="'.$collectiondata['homepage_element_8_two_mobile_style_title'].'"  name="homepage_element_8_two_mobile_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_two_mobile_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_two_mobile_style_link" value="'.$collectiondata['homepage_element_8_two_mobile_style_link'].'" name="homepage_element_8_two_mobile_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_two_mobile_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_two_mobile_style_target" name="homepage_element_8_two_mobile_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '30_70_boxes_full_width')
	      				{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_one_style_title" value="'.$collectiondata['homepage_element_8_three_one_style_title'].'" name="homepage_element_8_three_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_one_style_link"  value="'.$collectiondata['homepage_element_8_three_one_style_link'].'" name="homepage_element_8_three_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_three_one_style_target" name="homepage_element_8_three_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_two_style_title" value="'.$collectiondata['homepage_element_8_three_two_style_title'].'" name="homepage_element_8_three_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_two_style_link"  value="'.$collectiondata['homepage_element_8_three_two_style_link'].'" name="homepage_element_8_three_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_three_two_style_target" name="homepage_element_8_three_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_three_style_title"  value="'.$collectiondata['homepage_element_8_three_three_style_title'].'" name="homepage_element_8_three_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_three_three_style_link" value="'.$collectiondata['homepage_element_8_three_three_style_link'].'" name="homepage_element_8_three_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_three_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_three_three_style_target" name="homepage_element_8_three_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//if($selectElement == '70_30_boxes_full_width')
	      				{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_one_style_title"  value="'.$collectiondata['homepage_element_8_four_one_style_title'].'" name="homepage_element_8_four_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_one_style_link" value="'.$collectiondata['homepage_element_8_four_one_style_link'].'" name="homepage_element_8_four_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_four_one_style_target" name="homepage_element_8_four_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_two_style_title" value="'.$collectiondata['homepage_element_8_four_two_style_title'].'" name="homepage_element_8_four_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_two_style_link" value="'.$collectiondata['homepage_element_8_four_two_style_link'].'" name="homepage_element_8_four_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_four_two_style_target" name="homepage_element_8_four_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_three_style_title" value="'.$collectiondata['homepage_element_8_four_three_style_title'].'" name="homepage_element_8_four_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_four_three_style_link" value="'.$collectiondata['homepage_element_8_four_three_style_link'].'" name="homepage_element_8_four_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_four_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_four_three_style_target" name="homepage_element_8_four_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//if($selectElement == '33_%_640_by_400_three_boxes_full_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_one_style_title" value="'.$collectiondata['homepage_element_8_five_one_style_title'].'" name="homepage_element_8_five_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_one_style_link" value="'.$collectiondata['homepage_element_8_five_one_style_link'].'" name="homepage_element_8_five_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_five_one_style_target" name="homepage_element_8_five_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_two_style_title"  value="'.$collectiondata['homepage_element_8_five_two_style_title'].'" name="homepage_element_8_five_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_two_style_link" value="'.$collectiondata['homepage_element_8_five_two_style_link'].'" name="homepage_element_8_five_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_five_two_style_target" name="homepage_element_8_five_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_three_style_title"  value="'.$collectiondata['homepage_element_8_five_three_style_title'].'" name="homepage_element_8_five_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_five_three_style_link" value="'.$collectiondata['homepage_element_8_five_three_style_link'].'" name="homepage_element_8_five_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_five_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_five_three_style_target" name="homepage_element_8_five_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><button id="togglehomepage_element_8_five_three_style_image" style="" class="scalable show-hide" type="button"><span><span><span>Show / Hide Editor</span></span></span></button><div id="buttonshomepage_element_8_five_three_style_image" class="buttons-set"><button style="" onclick="MediabrowserUtility.openDialog(\''.$baseurl.'idealAdmin/cms_wysiwyg_images/index/target_element_id/homepage_element_8_five_three_style_image/\')" class="scalable add-image plugin" type="button"><span><span><span>Insert Image...</span></span></span></button></div><textarea name="homepage_element_8_five_three_style_image" title="" id="homepage_element_8_five_three_style_image" class="textarea " style="height:50px;" rows="2" cols="15">'.$collectiondata['homepage_element_8_five_three_style_image'].'</textarea><small>Image size must be 640*400 pixels</small></td>';
      						$str = $str . '<script type="text/javascript">';
      						$str = $str . ' openEditorPopup = function(url, name, specs, parent) {';
      						$str = $str . ' if ((typeof popups == "undefined") || popups[name] == undefined || popups[name].closed) {';
      						$str = $str . ' if (typeof popups == "undefined") {';
						...
						//if($selectElement == '25_%_480_by_400_four_boxes_full_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_one_style_title" value="'.$collectiondata['homepage_element_8_six_one_style_title'].'" name="homepage_element_8_six_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_one_style_link" value="'.$collectiondata['homepage_element_8_six_one_style_link'].'" name="homepage_element_8_six_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_six_one_style_target" name="homepage_element_8_six_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_two_style_title" value="'.$collectiondata['homepage_element_8_six_two_style_title'].'" name="homepage_element_8_six_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_two_style_link" value="'.$collectiondata['homepage_element_8_six_two_style_link'].'" name="homepage_element_8_six_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_six_two_style_target" name="homepage_element_8_six_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_three_style_title" value="'.$collectiondata['homepage_element_8_six_three_style_title'].'" name="homepage_element_8_six_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_three_style_link" value="'.$collectiondata['homepage_element_8_six_three_style_link'].'" name="homepage_element_8_six_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_six_three_style_target" name="homepage_element_8_six_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_four_style_title" value="'.$collectiondata['homepage_element_8_six_four_style_title'].'" name="homepage_element_8_six_four_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_four_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_six_four_style_link" value="'.$collectiondata['homepage_element_8_six_four_style_link'].'" name="homepage_element_8_six_four_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_six_four_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_six_four_style_target" name="homepage_element_8_six_four_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//if($selectElement == '33_%_346_by_170_three_boxes_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_one_style_title" value="'.$collectiondata['homepage_element_8_seven_one_style_title'].'" name="homepage_element_8_seven_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_one_style_link" value="'.$collectiondata['homepage_element_8_seven_one_style_link'].'" name="homepage_element_8_seven_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_seven_one_style_target" name="homepage_element_8_seven_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><button id="togglehomepage_element_8_seven_one_style_image" style="" class="scalable show-hide" type="button"><span><span><span>Show / Hide Editor</span></span></span></button><div id="buttonshomepage_element_8_seven_one_style_image" class="buttons-set"><button style="" onclick="MediabrowserUtility.openDialog(\''.$baseurl.'idealAdmin/cms_wysiwyg_images/index/target_element_id/homepage_element_8_seven_one_style_image/\')" class="scalable add-image plugin" type="button"><span><span><span>Insert Image...</span></span></span></button></div><textarea name="homepage_element_8_seven_one_style_image" title="" id="homepage_element_8_seven_one_style_image" class="textarea " style="height:50px;" rows="2" cols="15">'.$collectiondata['homepage_element_8_seven_one_style_image'].'</textarea><small>Image size must be 346*170 pixels</small></td>';
      						$str = $str . '<script type="text/javascript">';
      						$str = $str . ' openEditorPopup = function(url, name, specs, parent) {';
      						$str = $str . ' if ((typeof popups == "undefined") || popups[name] == undefined || popups[name].closed) {';
      						$str = $str . ' if (typeof popups == "undefined") {';
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_two_style_title" value="'.$collectiondata['homepage_element_8_seven_two_style_title'].'" name="homepage_element_8_seven_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_two_style_link" value="'.$collectiondata['homepage_element_8_seven_two_style_link'].'" name="homepage_element_8_seven_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_seven_two_style_target" name="homepage_element_8_seven_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_three_style_title" value="'.$collectiondata['homepage_element_8_seven_three_style_title'].'" name="homepage_element_8_seven_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_seven_three_style_link" value="'.$collectiondata['homepage_element_8_seven_three_style_link'].'" name="homepage_element_8_seven_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_seven_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_seven_three_style_target" name="homepage_element_8_seven_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><button id="togglehomepage_element_8_seven_three_style_image" style="" class="scalable show-hide" type="button"><span><span><span>Show / Hide Editor</span></span></span></button><div id="buttonshomepage_element_8_seven_three_style_image" class="buttons-set"><button style="" onclick="MediabrowserUtility.openDialog(\''.$baseurl.'idealAdmin/cms_wysiwyg_images/index/target_element_id/homepage_element_8_seven_three_style_image/\')" class="scalable add-image plugin" type="button"><span><span><span>Insert Image...</span></span></span></button></div><textarea name="homepage_element_8_seven_three_style_image" title="" id="homepage_element_8_seven_three_style_image" class="textarea " style="height:50px;" rows="2" cols="15">'.$collectiondata['homepage_element_8_seven_three_style_image'].'</textarea><small>Image size must be 346*170 pixels</small></td>';
      						$str = $str . '<script type="text/javascript">';
      						$str = $str . ' openEditorPopup = function(url, name, specs, parent) {';
      						$str = $str . ' if ((typeof popups == "undefined") || popups[name] == undefined || popups[name].closed) {';
      						$str = $str . ' if (typeof popups == "undefined") {';
      					...
      					//else if($selectElement == '33_%_346_by_346_three_boxes_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_one_style_title" value="'.$collectiondata['homepage_element_8_eight_one_style_title'].'" name="homepage_element_8_eight_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_one_style_link" value="'.$collectiondata['homepage_element_8_eight_one_style_link'].'" name="homepage_element_8_eight_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_eight_one_style_target" name="homepage_element_8_eight_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_two_style_title"  value="'.$collectiondata['homepage_element_8_eight_two_style_title'].'" name="homepage_element_8_eight_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_two_style_link" value="'.$collectiondata['homepage_element_8_eight_two_style_link'].'" name="homepage_element_8_eight_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_eight_two_style_target" name="homepage_element_8_eight_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_three_style_title" value="'.$collectiondata['homepage_element_8_eight_three_style_title'].'" name="homepage_element_8_eight_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_eight_three_style_link" value="'.$collectiondata['homepage_element_8_eight_three_style_link'].'" name="homepage_element_8_eight_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eight_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_eight_three_style_target" name="homepage_element_8_eight_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '33_%_346_by_346_three_boxes_middle_updown_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_one_style_title" value="'.$collectiondata['homepage_element_8_nine_one_style_title'].'" name="homepage_element_8_nine_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_one_style_link" value="'.$collectiondata['homepage_element_8_nine_one_style_link'].'" name="homepage_element_8_nine_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_nine_one_style_target" name="homepage_element_8_nine_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_two_up_style_title" value="'.$collectiondata['homepage_element_8_nine_two_up_style_title'].'" name="homepage_element_8_nine_two_up_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_two_up_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_two_up_style_link" value="'.$collectiondata['homepage_element_8_nine_two_up_style_link'].'" name="homepage_element_8_nine_two_up_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_two_up_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_nine_two_up_style_target" name="homepage_element_8_nine_two_up_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_two_down_style_title" value="'.$collectiondata['homepage_element_8_nine_two_down_style_title'].'" name="homepage_element_8_nine_two_down_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_two_down_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_two_down_style_link" value="'.$collectiondata['homepage_element_8_nine_two_down_style_link'].'" name="homepage_element_8_nine_two_down_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_two_down_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_nine_two_down_style_target" name="homepage_element_8_nine_two_down_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_three_style_title" value="'.$collectiondata['homepage_element_8_nine_three_style_title'].'" name="homepage_element_8_nine_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_nine_three_style_link" value="'.$collectiondata['homepage_element_8_nine_three_style_link'].'" name="homepage_element_8_nine_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_nine_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_nine_three_style_target" name="homepage_element_8_nine_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '33_%_346_by_346_three_boxes_leftright_updown_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_one_up_style_title" value="'.$collectiondata['homepage_element_8_ten_one_up_style_title'].'" name="homepage_element_8_ten_one_up_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_one_up_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_one_up_style_link" value="'.$collectiondata['homepage_element_8_ten_one_up_style_link'].'" name="homepage_element_8_ten_one_up_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_one_up_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_ten_one_up_style_target" name="homepage_element_8_ten_one_up_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_one_down_style_title" value="'.$collectiondata['homepage_element_8_ten_one_down_style_title'].'" name="homepage_element_8_ten_one_down_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_one_down_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_one_down_style_link" value="'.$collectiondata['homepage_element_8_ten_one_down_style_link'].'" name="homepage_element_8_ten_one_down_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_one_down_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_ten_one_down_style_target" name="homepage_element_8_ten_one_down_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_two_style_title" value="'.$collectiondata['homepage_element_8_ten_two_style_title'].'" name="homepage_element_8_ten_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_two_style_link" value="'.$collectiondata['homepage_element_8_ten_two_style_link'].'" name="homepage_element_8_ten_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_ten_two_style_target" name="homepage_element_8_ten_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_three_up_style_title" value="'.$collectiondata['homepage_element_8_ten_three_up_style_title'].'" name="homepage_element_8_ten_three_up_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_three_up_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_three_up_style_link" value="'.$collectiondata['homepage_element_8_ten_three_up_style_link'].'" name="homepage_element_8_ten_three_up_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_three_up_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_ten_three_up_style_target" name="homepage_element_8_ten_three_up_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><button id="togglehomepage_element_8_ten_three_up_style_image" style="" class="scalable show-hide" type="button"><span><span><span>Show / Hide Editor</span></span></span></button><div id="buttonshomepage_element_8_ten_three_up_style_image" class="buttons-set"><button style="" onclick="MediabrowserUtility.openDialog(\''.$baseurl.'idealAdmin/cms_wysiwyg_images/index/target_element_id/homepage_element_8_ten_three_up_style_image/\')" class="scalable add-image plugin" type="button"><span><span><span>Insert Image...</span></span></span></button></div><textarea name="homepage_element_8_ten_three_up_style_image" title="" id="homepage_element_8_ten_three_up_style_image" class="textarea " style="height:50px;" rows="2" cols="15">'.$collectiondata['homepage_element_8_ten_three_up_style_image'].'</textarea><small>Image size must be 346*170 pixels</small></td>';
      						$str = $str . '<script type="text/javascript">';
      						$str = $str . ' openEditorPopup = function(url, name, specs, parent) {';
      						$str = $str . ' if ((typeof popups == "undefined") || popups[name] == undefined || popups[name].closed) {';
      						$str = $str . ' if (typeof popups == "undefined") {';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_three_down_style_title" value="'.$collectiondata['homepage_element_8_ten_three_down_style_title'].'" name="homepage_element_8_ten_three_down_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_three_down_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_ten_three_down_style_link" value="'.$collectiondata['homepage_element_8_ten_three_down_style_link'].'" name="homepage_element_8_ten_three_down_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_ten_three_down_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_ten_three_down_style_target" name="homepage_element_8_ten_three_down_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
			      		...
			      		//else if($selectElement == '50_%_522_by_170_two_boxes_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_eleven_one_style_title" value="'.$collectiondata['homepage_element_8_eleven_one_style_title'].'" name="homepage_element_8_eleven_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eleven_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_eleven_one_style_link" value="'.$collectiondata['homepage_element_8_eleven_one_style_link'].'" name="homepage_element_8_eleven_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eleven_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_eleven_one_style_target" name="homepage_element_8_eleven_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_eleven_two_style_title" value="'.$collectiondata['homepage_element_8_eleven_two_style_title'].'" name="homepage_element_8_eleven_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eleven_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_eleven_two_style_link" value="'.$collectiondata['homepage_element_8_eleven_two_style_link'].'" name="homepage_element_8_eleven_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_eleven_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_eleven_two_style_target" name="homepage_element_8_eleven_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '50_%_522_by_346_two_boxes_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_twelve_one_style_title" value="'.$collectiondata['homepage_element_8_twelve_one_style_title'].'" name="homepage_element_8_twelve_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_twelve_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_twelve_one_style_link" value="'.$collectiondata['homepage_element_8_twelve_one_style_link'].'" name="homepage_element_8_twelve_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_twelve_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_twelve_one_style_target" name="homepage_element_8_twelve_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_twelve_two_style_title" value="'.$collectiondata['homepage_element_8_twelve_two_style_title'].'" name="homepage_element_8_twelve_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_twelve_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_twelve_two_style_link" value="'.$collectiondata['homepage_element_8_twelve_two_style_link'].'" name="homepage_element_8_twelve_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_twelve_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_twelve_two_style_target" name="homepage_element_8_twelve_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
	   					...
	   					//else if($selectElement == '1050_by_170_banner')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_thirteen_one_style_title" value="'.$collectiondata['homepage_element_8_thirteen_one_style_title'].'" name="homepage_element_8_thirteen_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_thirteen_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_thirteen_one_style_link" value="'.$collectiondata['homepage_element_8_thirteen_one_style_link'].'" name="homepage_element_8_thirteen_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_thirteen_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_thirteen_one_style_target" name="homepage_element_8_thirteen_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      			   	...
      			   	//	else if($selectElement == '1050_by_346_banner')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_fourteen_one_style_title" value="'.$collectiondata['homepage_element_8_fourteen_one_style_title'].'" name="homepage_element_8_fourteen_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fourteen_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_fourteen_one_style_link" value="'.$collectiondata['homepage_element_8_fourteen_one_style_link'].'" name="homepage_element_8_fourteen_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fourteen_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_fourteen_one_style_target" name="homepage_element_8_fourteen_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
			      		...
			      		//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_one_style_title" value="'.$collectiondata['homepage_element_8_fifthteen_one_style_title'].'" name="homepage_element_8_fifthteen_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_one_style_link" value="'.$collectiondata['homepage_element_8_fifthteen_one_style_link'].'" name="homepage_element_8_fifthteen_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_fifthteen_one_style_target" name="homepage_element_8_fifthteen_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_two_up_style_title" value="'.$collectiondata['homepage_element_8_fifthteen_two_up_style_title'].'" name="homepage_element_8_fifthteen_two_up_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_two_up_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_two_up_style_link" value="'.$collectiondata['homepage_element_8_fifthteen_two_up_style_link'].'" name="homepage_element_8_fifthteen_two_up_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_two_up_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_fifthteen_two_up_style_target" name="homepage_element_8_fifthteen_two_up_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_two_down_style_title" value="'.$collectiondata['homepage_element_8_fifthteen_two_down_style_title'].'" name="homepage_element_8_fifthteen_two_down_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_two_down_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_fifthteen_two_down_style_link" value="'.$collectiondata['homepage_element_8_fifthteen_two_down_style_link'].'" name="homepage_element_8_fifthteen_two_down_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_fifthteen_two_down_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_fifthteen_two_down_style_target" name="homepage_element_8_fifthteen_two_down_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
						 ...
						 //else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_one_style_title" value="'.$collectiondata['homepage_element_8_sixteen_one_style_title'].'" name="homepage_element_8_sixteen_one_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_one_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_one_style_link" value="'.$collectiondata['homepage_element_8_sixteen_one_style_link'].'" name="homepage_element_8_sixteen_one_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_one_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_sixteen_one_style_target" name="homepage_element_8_sixteen_one_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_two_style_title" value="'.$collectiondata['homepage_element_8_sixteen_two_style_title'].'" name="homepage_element_8_sixteen_two_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_two_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_two_style_link" value="'.$collectiondata['homepage_element_8_sixteen_two_style_link'].'" name="homepage_element_8_sixteen_two_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_two_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_sixteen_two_style_target" name="homepage_element_8_sixteen_two_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><button id="togglehomepage_element_8_sixteen_two_style_image" style="" class="scalable show-hide" type="button"><span><span><span>Show / Hide Editor</span></span></span></button><div id="buttonshomepage_element_8_sixteen_two_style_image" class="buttons-set"><button style="" onclick="MediabrowserUtility.openDialog(\''.$baseurl.'idealAdmin/cms_wysiwyg_images/index/target_element_id/homepage_element_8_sixteen_two_style_image/\')" class="scalable add-image plugin" type="button"><span><span><span>Insert Image...</span></span></span></button></div><textarea name="homepage_element_8_sixteen_two_style_image" title="" id="homepage_element_8_sixteen_two_style_image" class="textarea " style="height:50px;" rows="2" cols="15">'.$collectiondata['homepage_element_8_sixteen_two_style_image'].'</textarea><small>Image size must be 258*170 pixels</small></td>';
      						$str = $str . '<script type="text/javascript">';
      						$str = $str . ' openEditorPopup = function(url, name, specs, parent) {';
      						$str = $str . ' if ((typeof popups == "undefined") || popups[name] == undefined || popups[name].closed) {';
      						$str = $str . ' if (typeof popups == "undefined") {';
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_three_style_title" value="'.$collectiondata['homepage_element_8_sixteen_three_style_title'].'" name="homepage_element_8_sixteen_three_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_three_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_three_style_link" value="'.$collectiondata['homepage_element_8_sixteen_three_style_link'].'" name="homepage_element_8_sixteen_three_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_three_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_sixteen_three_style_target" name="homepage_element_8_sixteen_three_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
							...
							$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_four_style_title" value="'.$collectiondata['homepage_element_8_sixteen_four_style_title'].'" name="homepage_element_8_sixteen_four_style_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_four_style_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_sixteen_four_style_link" value="'.$collectiondata['homepage_element_8_sixteen_four_style_link'].'" name="homepage_element_8_sixteen_four_style_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_sixteen_four_style_target">Target:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_sixteen_four_style_target" name="homepage_element_8_sixteen_four_style_target" >';
      						foreach($targetarr as $targetarrkey => $targetarrvalue)
      						{
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_newarrival_enabled" id="homepage_element_8_newarrival_enabled">';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_special_enabled" id="homepage_element_8_special_enabled">';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_bestsellers_enabled" id="homepage_element_8_bestsellers_enabled">';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_mostviewed_enabled" id="homepage_element_8_mostviewed_enabled">';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
							...
							$str = $str . '<td class="value">';
							$str = $str . '<select class=" select" name="homepage_element_8_show_featured_product_name_enabled" id="homepage_element_8_show_featured_product_name_enabled">';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<select class=" select" name="homepage_element_8_show_featured_product_price_enabled" id="homepage_element_8_show_featured_product_price_enabled">';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_visible_product" value="'.$collectiondata["homepage_element_8_show_featured_product_visible_product"].'" style="width: 50px; " />';
							$str = $str . '</td>';
							$str = $str . '</tr>';
							$str = $str . '<tr>';
							$str = $str . '<td class="label"><label for="homepage_element_8_show_featured_product_button_text">Show Product Button Text:</label></td>';
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_button_text" value="'.$collectiondata["homepage_element_8_show_featured_product_button_text"].'" style="width: 150px; " />';
							$str = $str . '</td>';
							$str = $str . '</tr>';
							$str = $str . '<tr>';
							...
							$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_show_featured_product_button_url" id="homepage_element_8_show_featured_product_button_url">';
							...
							$str = $str . '</tr>';
      						...
      						$str = $str . '<td class="label"><label for="homepage_element_8_newarrival_enabled">Show New Arrival:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_newarrival_enabled" id="homepage_element_8_newarrival_enabled">';
      						foreach($newarrival as $newarrivalkey => $newarrivalvalue)
      						{
      							if($collectiondata["homepage_element_8_newarrival_enabled"] == $newarrivalkey)
      							{
      						...
      						$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_newarrival_title" value="'.$collectiondata["homepage_element_8_show_featured_product_newarrival_title"].'" style="width: 150px; " />';
      						$str = $str . '</td>';
      						$str = $str . '</tr>';
      						$str = $str . '</tbody>';
      						$str = $str . '</table>';
      						...
      						$str = $str . '<td class="label"><label for="homepage_element_8_special_enabled">Show Special :</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_special_enabled" id="homepage_element_8_special_enabled">';
      						foreach($special as $specialkey => $specialvalue)
      						{
      							if($collectiondata["homepage_element_8_special_enabled"] == $specialkey)
      							{
      						...
      						$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_special_title" value="'.$collectiondata["homepage_element_8_show_featured_product_special_title"].'" style="width: 150px; " />';
      						$str = $str . '</td>';
      						$str = $str . '</tr>';
      						$str = $str . '</tbody>';
      						$str = $str . '</table>';
      						...
      						$str = $str . '<td class="label"><label for="homepage_element_8_bestsellers_enabled">Show Best Sellers :</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_bestsellers_enabled" id="homepage_element_8_bestsellers_enabled">';
      						foreach($bestsellers as $bestsellerskey => $bestsellersvalue)
      						{
      							if($collectiondata["homepage_element_8_bestsellers_enabled"] == $bestsellerskey)
      							{
      						...
      						$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_bestsellers_title" value="'.$collectiondata["homepage_element_8_show_featured_product_bestsellers_title"].'" style="width: 150px; " />';
      						$str = $str . '</td>';
      						$str = $str . '</tr>';
      						$str = $str . '</tbody>';
      						$str = $str . '</table>';
      						...
      						$str = $str . '<td class="label"><label for="homepage_element_8_mostviewed_enabled">Show Most Viewed :</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_mostviewed_enabled" id="homepage_element_8_mostviewed_enabled">';
      						foreach($mostviewed as $mostviewedkey => $mostviewedvalue)
      						{
      							if($collectiondata["homepage_element_8_mostviewed_enabled"] == $mostviewedkey)
      							{
      						...
      						$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_mostviewed_title" value="'.$collectiondata["homepage_element_8_show_featured_product_mostviewed_title"].'" style="width: 150px; " />';
      						$str = $str . '</td>';
      						$str = $str . '</tr>';
      						$str = $str . '</tbody>';
      						$str = $str . '</table>';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select homepage_element_show_featured_product" name="homepage_element_8_featured_enabled" id="homepage_element_8_featured_enabled">';
      						...
      						$str = $str . '<input type="text" name="homepage_element_8_show_featured_product_featured_title" value="'.$collectiondata["homepage_element_8_show_featured_product_featured_title"].'" style="width: 150px; " />';
      						$str = $str . '</td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_featured_category_id">Featured Category:</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_featured_category_id" id="homepage_element_8_featured_category_id">';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_brand_manager_enabled" id="homepage_element_8_brand_manager_enabled">';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<input type="text" class=" input-text" value="'.$collectiondata["homepage_element_8_brand_manager_title"].'" name="homepage_element_8_brand_manager_title" id="homepage_element_8_brand_manager_title"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_brand_manager_visiblebrands">Show Visible Brands</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<input type="text" class=" input-text" value="'.$collectiondata["homepage_element_8_brand_manager_visiblebrands"].'" name="homepage_element_8_brand_manager_visiblebrands" id="homepage_element_8_brand_manager_visiblebrands"></td>';
      						$str = $str . '</tr>';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_brand_manager_autoscroll_enabled" id="homepage_element_8_brand_manager_autoscroll_enabled">';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select id="homepage_element_8_brand_manager_target" name="homepage_element_8_brand_manager_target" >';
      					...
      					//else if($selectElement == '33_%_left_50_%_right_boxes_right_updown_width')
      					{
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_slideshow_banner_style" id="homepage_element_8_slideshow_banner_style" onChange="homepageBannerStyle(\'homepage_element_8_slideshow_banner_style\',this.value);">';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<input type="text" class=" input-text" value="'.$collectiondata["homepage_element_8_slideshow_banner_style_nearby_width"].'" name="homepage_element_8_slideshow_banner_style_nearby_width" id="homepage_element_8_slideshow_banner_style_nearby_width"></td>';
      						$str = $str . '</tr>';			
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_slideshow_banner_style_nearby_height">Height</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<input type="text" class=" input-text" value="'.$collectiondata["homepage_element_8_slideshow_banner_style_nearby_height"].'" name="homepage_element_8_slideshow_banner_style_nearby_height" id="homepage_element_8_slideshow_banner_style_nearby_height"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_slideshow_banner_style_nearby_slidesSpacing">Slides Spacing</label></td>';
      						$str = $str . '<td class="value">';
      						$str = $str . '<input type="text" class=" input-text" value="'.$collectiondata["homepage_element_8_slideshow_banner_style_nearby_slidesSpacing"].'" name="homepage_element_8_slideshow_banner_style_nearby_slidesSpacing" id="homepage_element_8_slideshow_banner_style_nearby_slidesSpacing"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '</tbody>';
      						$str = $str . '</table>';
      						$str = $str . '</td>';
...
//							echo $collectiondata["homepage_element_8_diamondrow_style_background_image"]; exit;
							if($collectiondata["homepage_element_8_diamondrow_style_background_image"])
							{
								...
								$str = $str . '<input type="file" class="input-file" value="'.$collectiondata["homepage_element_8_diamondrow_style_background_image"].'" name="homepage_element_8_diamondrow_style_background_image" id="homepage_element_8_diamondrow_style_background_image">';
								$str = $str . '<span class="delete-image"><input type="checkbox" name="homepage_element_8_diamondrow_style_background_image[delete]" value="1" class="checkbox" id="homepage_element_8_diamondrow_style_background_image_delete"><label for="homepage_element_8_diamondrow_style_background_image_delete"> Delete Image</label><input type="hidden" name="homepage_element_8_diamondrow_style_background_image[value]" value="'.$collectiondata["homepage_element_8_diamondrow_style_background_image"].'"></span>';
							}
							else
							{
								$str = $str . '<input type="file" class="input-file" value="" name="homepage_element_8_diamondrow_style_background_image" id="homepage_element_8_diamondrow_style_background_image">';
							}
							$str = $str . '</td>';
							$str = $str . '</tr>';
							$str = $str . '<tr>';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" class="input-text mColorPicker" value="'.$collectiondata["homepage_element_8_diamondrow_style_background_color"].'" name="homepage_element_8_diamondrow_style_background_color" id="homepage_element_8_diamondrow_style_background_color" data-hex="true" style="background-color: '.$collectiondata["homepage_element_8_diamondrow_style_background_color"].'; ">';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<select name="homepage_element_8_diamondrow_style_font" id="homepage_element_8_diamondrow_style_font">';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" class="input-text mColorPicker" value="'.$collectiondata["homepage_element_8_diamondrow_style_button_backgroundcolor"].'" name="homepage_element_8_diamondrow_style_button_backgroundcolor" id="homepage_element_8_diamondrow_style_button_backgroundcolor" data-hex="true" style="background-color: '.$collectiondata["homepage_element_8_diamondrow_style_button_backgroundcolor"].'; ">';
							...
							$str = $str . '<select name="homepage_element_8_diamondrow_style_select" class="homepage_element_8_diamondrow_style_image" id="homepage_element_8_diamondrow_style_select" onChange="diamondstyle(this.value,\'homepage_element_8_diamondrow_style_image\');">';
							foreach($diamondstyle as $diamondstylekey => $diamondstylevalue)
							{
							...
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" name="homepage_element_8_diamondrow_dynamic_style_content_title" id="homepage_element_8_diamondrow_dynamic_style_content_title" value="'.$collectiondata['homepage_element_8_diamondrow_dynamic_style_content_title'].'" />';
							$str = $str . '</td>';
							$str = $str . '</tr>';
							...
							$str = $str . '<td class="value">';
							$str = $str . '<input type="text" name="homepage_element_8_diamondrow_dynamic_style_content_title_url" id="homepage_element_8_diamondrow_dynamic_style_content_title_url" value="'.$collectiondata['homepage_element_8_diamondrow_dynamic_style_content_title_url'].'" />';
							$str = $str . '</td>';
							$str = $str . '</tr>';
							...
							else
							{
      						...
      						$str = $str . '<button id="addbtn" onClick="addshaperow(\'homepage_element_8_diamondrow\'); return false;"><span>Add</span></button>';
      						...
      						$str = $str . '<td colspan=3><input type="hidden" name="homepage_element_8_diamondrow_dynamic_shape_table_row_count" class="homepage_element_8_diamondrow_dynamic_shape_table_row_count" value="'.$collectiondata['homepage_element_8_diamondrow_dynamic_shape_table_row_count'].'" /></td>';
      						$str = $str . '</tr>';
      						...
      						{
      							$str = $str . '<tr>';
      							$str = $str . '<td><input type="hidden" class="homepage_element_diamondrow_dynamic_shape_table_row" name="homepage_element_8_diamondrow_dynamic_shape_table_row'.$shapeconut.'" value='.$collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_row".$shapeconut].' />';
      							...
      							if($collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_image_row".$shapeconut."_image"])
								{
									...
									$str = $str . '<input type="file" class="input-file" value="'.$collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_image_row".$shapeconut."_image"].'" name="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image" id="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image">';
									$str = $str . '<span class="delete-image"><input type="checkbox" name="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image[delete]" value="1" class="checkbox" id="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image_delete"><label for="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image_delete"> Delete Image</label><input type="hidden" name="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image[value]" value="'.$collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_image_row".$shapeconut."_image"].'"></span>';
								}
      							else
      							{
      								$str = $str . '<input type="file" class="input-file" value="" name="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image" id="homepage_element_8_diamondrow_dynamic_shape_table_image_row'.$shapeconut.'_image">';
      							}      							
      							$str = $str . '</td>';
      							
      							$str = $str . '<td><input type="text" name="homepage_element_8_diamondrow_dynamic_shape_table_title_row'.$shapeconut.'" value="'.$collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_title_row".$shapeconut].'"></td>';
      							$str = $str . '<td><select name="homepage_element_8_diamondrow_dynamic_shape_table_enable_row'.$shapeconut.'" style="width: 100px;" >';
      							...
      							$str = $str . '</select></td>';
      							$str = $str . '<td><input type="text" name="homepage_element_8_diamondrow_dynamic_shape_table_sortorder_row'.$shapeconut.'" value="'.$collectiondata["homepage_element_8_diamondrow_dynamic_shape_table_sortorder_row".$shapeconut].'"></td>';
      							$str = $str . '</tr>';
      						}    						
						...
						//else if($selectElement == '1920_by_800_banner')
						{
							...
							$str = $str . '<td class="value">';
							$str = $str . '<select class=" select" name="homepage_element_8_textrow_enabled" id="homepage_element_8_textrow_enabled">';
							...
							foreach($markerarr as $marker)
							{
								if($homepage_element_8_textrow_style_marker_checkbox[$marker] == $marker){
									$str = $str . '<li><input type="checkbox" value="'.$marker.'" name="homepage_element_8_textrow_style_marker_checkbox['.$marker.']" id="homepage_element_8_textrow_style_marker_checkbox['.$marker.']" checked > <label for="'.$marker.'" >'.$marker.'</label></li>';
								}
								else {
									$str = $str . '<li><input type="checkbox" value="'.$marker.'" name="homepage_element_8_textrow_style_marker_checkbox['.$marker.']" id="homepage_element_8_textrow_style_marker_checkbox['.$marker.']"> <label for="'.$marker.'">'.$marker.'</label></li>';
								}
							}
							$str = $str . '</ul>';
							$str = $str . '</td>';
							...
							if($collectiondata["homepage_element_8_textrow_style_marker_image"])
							{
								...
								$str = $str . '<input type="file" class="input-file" value="'.$collectiondata["homepage_element_8_textrow_style_marker_image"].'" name="homepage_element_8_textrow_style_marker_image" id="homepage_element_8_textrow_style_marker_image">';
								$str = $str . '<span class="delete-image"><input type="checkbox" name="homepage_element_8_textrow_style_marker_image[delete]" value="1" class="checkbox" id="homepage_element_8_textrow_style_marker_image_delete"><label for="homepage_element_8_textrow_style_marker_image_delete"> Delete Image</label><input type="hidden" name="homepage_element_8_textrow_style_marker_image[value]" value="'.$collectiondata["homepage_element_8_textrow_style_marker_image"].'"></span>';
							}
							else
							{
								$str = $str . '<input type="file" class="input-file" value="" name="homepage_element_8_textrow_style_marker_image" id="homepage_element_8_textrow_style_marker_image">';
							}
							$str = $str . '</td>';
							$str = $str . '</tr>';
							$str = $str . '<tr>';
						...
						//else if($selectElement == '1920_by_800_banner')
						{
      						...
      						$str = $str . '<td class="value"><input id="homepage_element_8_show_image_with_feature_slider_one_title"  value="'.$collectiondata['homepage_element_8_show_image_with_feature_slider_one_title'].'"  name="homepage_element_8_show_image_with_feature_slider_one_title"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str .	'<tr>';
      						$str = $str . '<td class="label"><label for="homepage_element_8_show_image_with_feature_slider_one_link">Link:</label></td>';
      						$str = $str . '<td class="value"><input id="homepage_element_8_show_image_with_feature_slider_one_link" value="'.$collectiondata['homepage_element_8_show_image_with_feature_slider_one_link'].'" name="homepage_element_8_show_image_with_feature_slider_one_link"  type="text" class=" input-text"></td>';
      						$str = $str . '</tr>';
      						$str = $str . '<tr>';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_image_with_featured_enabled" id="homepage_element_8_image_with_featured_enabled">';
      						...
      						$str = $str . '<td class="value">';
      						$str = $str . '<select class=" select" name="homepage_element_8_image_with_featured_category_id" id="homepage_element_8_image_with_featured_category_id">';
