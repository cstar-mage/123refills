...
jq(window).load(function(){
	  ...
	  jq('#evolved_form_social input[name="evolved_form_social[social_icons_size]"]').click(function() {
		...
		if(!jq('#evolved_form_social input[name="evolved_form_social[social_icons_size]"]').is(':checked')) 
		{ jq('input[name="evolved_form_social[social_icons_size]"]#social_icons_size16').click(); }
		else
		{
...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Tab_Social extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('social_icons_size', 'radios', array(
      		...
      		'name'      => 'evolved_form_social[social_icons_size]',
      		'values' => array(
      ...
      $fieldset->addField('social_icons_theme', 'select', array(
      		...
      		'name'      => 'evolved_form_social[social_icons_theme]',
