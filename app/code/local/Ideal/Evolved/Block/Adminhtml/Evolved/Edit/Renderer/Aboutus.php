...
//		if($selectElement == "aboutus_element_style_one_one_column")
			...
			//$str = '<table cellspacing="0" class="form-list">';
				$str .= '<tbody>';
					$str .= '<tr>';
						...
						$str .= '<td class="value">';
						$str .= '<input type="text" id="aboutus_element_style_one_page_title" name="evolved_homepage_aboutus[aboutus_element_style_one_page_title]" value="'.$collectiondata['aboutus_element_style_one_page_title'].'" class=" input-text">';
						$str .= '</td>';
					$str .= '</tr>';
					$str .= '<tr>';
						$str .= '<td class="label"><label for="aboutus_element_style_one_page_sub_title">Page Sub-Title:</label></td>';
						$str .= '<td class="value">';
						$str .= '<input type="text" id="aboutus_element_style_one_page_sub_title" name="evolved_homepage_aboutus[aboutus_element_style_one_page_sub_title]" value="'.$collectiondata['aboutus_element_style_one_page_sub_title'].'" class=" input-text">';
						$str .= '</td>';
					$str .= '</tr>';
					$str .= '<tr>';
						...
						$str .= '<input type="file" class="input-file" value="'.$collectiondata['aboutus_element_style_one_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_one_upload_banner]" id="aboutus_element_style_one_upload_banner">';
						$str .= '</td>';
					$str .= '</tr>';
					$str .= '<tr>';
						$str .= '<td class="label"><label for="aboutus_element_style_one_current_banner">Current Banner:</label></td>';
						$str .= '<td class="value">';
						$str .= '<img src="'."/media/".$collectiondata['aboutus_element_style_one_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_one_current_banner]" id="aboutus_element_style_one_current_banner" width="300px" height="100px" />';
						$str .= '</td>';
					$str .= '</tr>';
					$str .= '<tr>';
	...
	//	elseif($selectElement == "aboutus_element_style_two_two_column_with_50_by_50")
							...
							$str .= '<table cellspacing="0" class="form-list">';
								$str .= '<tbody>';
									$str .= '<tr>';
										...
										$str .= '<td class="value">';
										$str .= '<input type="text" id="aboutus_element_style_two_page_title" name="evolved_homepage_aboutus[aboutus_element_style_two_page_title]" value="'.$collectiondata['aboutus_element_style_two_page_title'].'" class=" input-text">';
										$str .= '</td>';
									$str .= '</tr>';
									$str .= '<tr>';
										$str .= '<td class="label"><label for="aboutus_element_style_two_page_sub_title">Page Sub-Title:</label></td>';
										$str .= '<td class="value">';
										$str .= '<input type="text" id="aboutus_element_style_two_page_sub_title" name="evolved_homepage_aboutus[aboutus_element_style_two_page_sub_title]" value="'.$collectiondata['aboutus_element_style_two_page_sub_title'].'" class=" input-text">';
										$str .= '</td>';
									$str .= '</tr>';
									$str .= '<tr>';
										...
										$str .= '<input type="file" class="input-file" value="'.$collectiondata['aboutus_element_style_two_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_two_upload_banner]" id="aboutus_element_style_two_upload_banner">';
										$str .= '</td>';
									$str .= '</tr>';
									$str .= '<tr>';
										$str .= '<td class="label"><label for="aboutus_element_style_two_current_banner">Current Banner:</label></td>';
										$str .= '<td class="value">';
										$str .= '<img src="'."/media/".$collectiondata['aboutus_element_style_two_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_two_current_banner]" id="aboutus_element_style_two_current_banner" width="300px" height="100px" />';
										$str .= '</td>';
									$str .= '</tr>';
								$str .= '</tbody>';
							$str .= '</table>';
		...
		//elseif($selectElement == "aboutus_element_style_three_two_column_with_30_by_70")
		{
			...
			$str .= '<td class="value">';
			$str .= '<input type="text" id="aboutus_element_style_three_page_title" name="evolved_homepage_aboutus[aboutus_element_style_three_page_title]" value="'.$collectiondata['aboutus_element_style_three_page_title'].'" class=" input-text">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			$str .= '<td class="label"><label for="aboutus_element_style_three_page_sub_title">Page Sub-Title:</label></td>';
			$str .= '<td class="value">';
			$str .= '<input type="text" id="aboutus_element_style_three_page_sub_title" name="evolved_homepage_aboutus[aboutus_element_style_three_page_sub_title]" value="'.$collectiondata['aboutus_element_style_three_page_sub_title'].'" class=" input-text">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			...
			$str .= '<input type="file" class="input-file" value="'.$collectiondata['aboutus_element_style_three_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_three_upload_banner]" id="aboutus_element_style_three_upload_banner">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			$str .= '<td class="label"><label for="aboutus_element_style_three_current_banner">Current Banner:</label></td>';
			$str .= '<td class="value">';
			$str .= '<img src="'."/media/".$collectiondata['aboutus_element_style_three_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_three_current_banner]" id="aboutus_element_style_three_current_banner" width="300px" height="100px" />';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '</tbody>';
			$str .= '</table>';
		...
		//elseif($selectElement == "aboutus_element_style_four_two_column_with_70_by_30")
		{
			...
			$str .= '<td class="value">';
			$str .= '<input type="text" id="aboutus_element_style_four_page_title" name="evolved_homepage_aboutus[aboutus_element_style_four_page_title]" value="'.$collectiondata['aboutus_element_style_four_page_title'].'" class=" input-text">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			$str .= '<td class="label"><label for="aboutus_element_style_four_page_sub_title">Page Sub-Title:</label></td>';
			$str .= '<td class="value">';
			$str .= '<input type="text" id="aboutus_element_style_four_page_sub_title" name="evolved_homepage_aboutus[aboutus_element_style_four_page_sub_title]" value="'.$collectiondata['aboutus_element_style_four_page_sub_title'].'" class=" input-text">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			...
			$str .= '<input type="file" class="input-file" value="'.$collectiondata['aboutus_element_style_four_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_four_upload_banner]" id="aboutus_element_style_four_upload_banner">';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '<tr>';
			$str .= '<td class="label"><label for="aboutus_element_style_four_current_banner">Current Banner:</label></td>';
			$str .= '<td class="value">';
			$str .= '<img src="'."/media/".$collectiondata['aboutus_element_style_four_upload_banner'].'" name="evolved_homepage_aboutus[aboutus_element_style_four_current_banner]" id="aboutus_element_style_four_current_banner" width="300px" height="100px" />';
			$str .= '</td>';
			$str .= '</tr>';
			$str .= '</tbody>';
			$str .= '</table>';
