...
//      echo $evolveddata1['value'];
      ...
      $fieldsetStore->addField('general_store_information_name', 'text', array(
      		...
      		'name'      => 'evolved_form_general_store[config][general_store_information_name]',
      ...
      $fieldsetStore->addField('general_store_information_website_url', 'text', array(
      		...
      		'name'      => 'evolved_form_general_store[general_store_information_website_url]',
      ));
      
      $fieldsetStore->addField('general_store_information_phone', 'text', array(
      		'label'     => Mage::helper('evolved')->__('Store Contact Telephone:'),
      		'name'      => 'evolved_form_general_store[config][general_store_information_phone]',
      ...
      if(count($statearray) != 0)
      {
      	$fieldsetStore->addField('general_store_state', 'select', array(
      			'name'  => 'evolved_form_general_store[general_store_state]',
      			'label'     => 'Region/State',
      ...
      $country = $fieldsetStore->addField('general_store_country', 'select', array(
      		'name'  => 'evolved_form_general_store[general_store_country]',
      		'label'     => 'Country',
      ...
      */
      ...
      $fieldsetStore->addField('trans_email_ident_general_email', 'text', array(
      		...
      		'name'      => 'evolved_form_general_store[config][trans_email_ident_general_email]',
	 ...
	 $cms_address_fieldset->addField('cms_address_state', 'select', array(
      ...
      $fieldsetCSS->addField('general_main_color', 'colorpicker', array(
          ...
          'required'  => false,
          'name'      => 'evolved_form_general_css[general_main_color]',
      ...
      $fieldsetgoogleapp->addField('general_googleapps_username', 'text', array(
      		...
      		//'class'     => 'color {hash:true}', // for default magento color picker
      		'name'      => 'evolved_form_general_googleapps[general_googleapps_username]',
      ));
      
      $fieldsetgoogleapp->addField('general_googleapps_password', 'password', array(
      		'label'     => Mage::helper('evolved')->__('Password:'),
      		//'class'     => 'color {hash:true}', // for default magento color picker
      		'name'      => 'evolved_form_general_googleapps[general_googleapps_password]',
      ));
      
      $fieldsetmiscellaneous = $form->addFieldset('evolved_form_general_miscellaneous', array('legend'=>Mage::helper('evolved')->__('Miscellaneous Code')));
      $fieldsetmiscellaneous->addField('general_miscellaneous_head_scripts', 'textarea', array(
      		'label'     => Mage::helper('evolved')->__('Head Scripts:'),
      		'name'      => 'evolved_form_general_miscellaneous[config][general_miscellaneous_head_scripts]',
      ));
      
      $fieldsetmiscellaneous->addField('general_miscellaneous_footer_html', 'textarea', array(
      		'label'     => Mage::helper('evolved')->__('Footer HTML:'),
      		'name'      => 'evolved_form_general_miscellaneous[config][general_miscellaneous_footer_html]',
      ));
