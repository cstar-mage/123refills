		...
		try {
			...
			if(isset($_FILES['design_header_logo_src']['name']) && $_FILES['design_header_logo_src']['name'] != '') {
				try {
					...
					$this->_redirect('adminhtml/logo/new');
					return;
				}
			}
			...
			if(isset($_FILES['baseimg_placeholder_src']['name']) && $_FILES['baseimg_placeholder_src']['name'] != '') {
				try {
					...
					copy($media_path."/catalog/product/placeholder/default/".$_FILES['baseimg_placeholder_src']['name'] , $skinPath. "/images/catalog/product/placeholder/image.jpg" );
			...
			if(isset($_FILES['smallimage_placeholder_src']['name']) && $_FILES['smallimage_placeholder_src']['name'] != '') {
				try {
					...
					copy($media_path."/catalog/product/placeholder/default/".$_FILES['smallimage_placeholder_src']['name'] , $skinPath. "/images/catalog/product/placeholder/small_image.jpg" );
			...
			if(isset($_FILES['thumbnail_placeholder_src']['name']) && $_FILES['thumbnail_placeholder_src']['name'] != '') {
				try {
					...
					copy($media_path."/catalog/product/placeholder/default/".$_FILES['thumbnail_placeholder_src']['name'] , $skinPath. "/images/catalog/product/placeholder/thumbnail.jpg");
