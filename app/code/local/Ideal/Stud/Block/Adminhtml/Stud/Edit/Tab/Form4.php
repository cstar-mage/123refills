...
class Ideal_stud_Block_Adminhtml_Stud_Edit_Tab_Form4 extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('stud_form', array('legend'=>Mage::helper('stud')->__('Manage Stud Price')));
...
*/      $fieldset->addField('metal_price', 'gallery12', array(
          'label'     => Mage::helper('stud')->__('Metal Price'),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'metal_price',
      ));	  
