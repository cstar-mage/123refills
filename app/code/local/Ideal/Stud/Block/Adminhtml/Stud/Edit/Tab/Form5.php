...
class Ideal_stud_Block_Adminhtml_Stud_Edit_Tab_Form5 extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('stud_form', array('legend'=>Mage::helper('stud')->__('Manage Princess Price')));
...
*/      $fieldset->addField('carat', 'gallery13', array(
