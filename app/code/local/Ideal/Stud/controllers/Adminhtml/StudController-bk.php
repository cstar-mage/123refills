		...
		try{
			...
			foreach ($post as $key => $value){
				...
				if(strpos($key, $findme)){					
					...
					if($secondexplode['0']==10){
						unset($jksi);
						$jksi=array("jksi" => $value);
						//print_r($jksi);
						//echo $key ."->".$value."<br>";						
					}else if($secondexplode['0']==11){
						unset($jkind);
						$jkind=array("jkind" => $value);
						//print_r($jkind);
						//echo $key ."->".$value."<br>";						
					}else if($secondexplode['0']==12){
						$dataid=$value;
						$data = array_merge($carat,$fgvs,$fgsi,$fgind,$shape,$hivs,$hisi,$hiind,$jkvs,$jksi,$jkind);
						/*echo "---Start---<br>";
						print_r($data);
						echo "---End---<br>";*/
						if($dataid != ""){
							$model = Mage::getModel('stud/stud')->load($dataid)->addData($data);
							$model->setId($dataid)->save();
						}else{
							$model = Mage::getSingleton('stud/stud')->setData($data);
							$model->save();
						}				
					}else if($secondexplode['0']==2){	
						unset($fgvs);
						$fgvs=array("fgvs" => $value);
						//print_r($fgvs);
						//echo $key ."->".$value."<br>";
					}else if($secondexplode['0']==3){
						unset($fgsi);
						$fgsi=array("fgsi" => $value);
						//print_r($fgsi);
						//echo $key ."->".$value."<br>";											
					}else if($secondexplode['0']==4){	
						unset($fgind);
						$fgind=array("fgind" => $value);
						//print_r($fgind);
						//echo $key ."->".$value."<br>";											
					}else if($secondexplode['0']==5){
						unset($shape);
						$shape=array("shape" => $value);
						//print_r($shape);
						//echo $key ."->".$value."<br>";										
					}else if($secondexplode['0']==6){	
						unset($hivs);
						$hivs=array("hivs" => $value);
						//print_r($hivs);
						//echo $key ."->".$value."<br>";											
					}else if($secondexplode['0']==7){	
						unset($hisi);
						$hisi=array("hisi" => $value);
						//print_r($hisi);
						//echo $key ."->".$value."<br>";										
					}else if($secondexplode['0']==8){
						unset($hiind);
						$hiind=array("hiind" => $value);
						//print_r($hiind);
						//echo $key ."->".$value."<br>";											
					}else if($secondexplode['0']==9){
						unset($jkvs);
						$jkvs=array("jkvs" => $value);
						//print_r($jkvs);
						//echo $key ."->".$value."<br>";															
					}else if($secondexplode['0']==1){	
						unset($carat);
						$carat=array("carat" => $value);
						//print_r($carat);
						//echo $key ."->".$value."<br>";										
					}
				}	
