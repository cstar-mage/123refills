...
class Ideal_Seeitperson_IndexController extends Mage_Core_Controller_Front_Action
{
	...
	const XML_PATH_EMAIL_TEMPLATE_USER   = 'seeitperson/email/email_template_user';
...
public function personpostAction()
	{
		...
		if ($data) {
			...
			try {
                ...
                //echo Mage::getStoreConfig(self::XML_PATH_EMAIL_TEMPLATE);
               //echo Mage::getStoreConfig(self::XML_PATH_EMAIL_TEMPLATE_USER);
                //echo "<br>";
