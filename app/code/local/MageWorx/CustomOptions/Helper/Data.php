...
class MageWorx_CustomOptions_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    const XML_PATH_CUSTOMOPTIONS_DEPENDENT_ENABLED = 'mageworx_sales/customoptions/dependent_enabled';
    const XML_PATH_CUSTOMOPTIONS_HIDE_DEPENDENT_OPTION = 'mageworx_sales/customoptions/hide_dependent_option';    
    ...
    public function canShowQtyPerOptionInCart() {
        return Mage::getStoreConfig('mageworx_sales/customoptions/show_qty_per_option_in_cart');
    }
    ...
    public function getImagesThumbnailsSize() {        
        return intval(Mage::getStoreConfig('mageworx_sales/customoptions/images_thumbnails_size'));
    }
