...
class Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('used_for_dyncatprod_by', 'select', array(
        		'name'      => 'used_for_dyncatprod_by',
        		'label'     => Mage::helper('catalog')->__('Used for Dynamic Category Product Listing'),
        		'title'     => Mage::helper('catalog')->__('Used for Dynamic Category Product Listing'),
        		'values'    => $yesnoSource,
        ));
