	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$model->save();
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('uploadproduct')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('uploadproduct')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
	}
