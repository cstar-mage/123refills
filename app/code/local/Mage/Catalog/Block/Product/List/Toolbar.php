...
class Mage_Catalog_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    public function getCurrentOrder()
    {
        ...
        //created new attribute for this custom sort order "internal_category_sort"
        //this will be applicable for default sort for search result only.
        if(Mage::app()->getFrontController()->getAction()->getFullActionName() == 'catalogsearch_result_index') {
        	$defaultOrder  = 'internal_category_sort';
        	Mage::getSingleton('catalog/session')->setSortDirection('asc');
        }
