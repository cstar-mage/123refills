    		...
    		new Ajax.Request(this.ajaxUrl, {
                ...
                onSuccess: function(transport) {
                    if (transport.responseJSON){
                        ...
                        var descount1 = jQuery("#finder-2--6 option").length;
                        if(descount1 == 0){
                               jQuery('#finder-2--6').append('<option>Printer Model</option>');     
                        }
                        var descount2 = jQuery("#finder-1--3 option").length;
                        if(descount2 == 0){
                            jQuery('#finder-1--3').append('<option>Printer Model</option>');     
                        }
