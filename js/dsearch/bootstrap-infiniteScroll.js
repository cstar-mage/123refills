...
!function ($) {
    ...
    InfiniteScroll.prototype = {
        ...
        loadMore: function () {
			...
			if(data.reset_offset){$this.currentPage=0;}
			//if(data.end_of_results){$this.endOfResults=false;}
			
            data.offset = ($this.currentPage)*20;
			data.limit = 20;
			
			$this.currentPage += 1;
 
			$this.$element.find('#end-of-results').addClass('hide');
