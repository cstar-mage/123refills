...
(function ($) {
    $.widget("ui.multiselect", {
        ...
        _create: function () {
            ...
            this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="count">0 ' + ($.ui.multiselect.locale.itemsCount + 1) + '</span></div>').appendTo(this.selectedContainer);
            this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" class="search empty ui-widget-content ui-corner-all"/> </div>').appendTo(this.availableContainer);
