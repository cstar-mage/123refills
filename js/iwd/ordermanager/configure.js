ProductConfigureIWDOM = Class.create();
ProductConfigureIWDOM.prototype = {
    ...
    initialize: function() {
        ...
        this.current.listType = 'iwd_quote_items';
    },
    ...
    _initWindowElements: function() {
        this.blockWindow                = $('iwd_om_product_composite_configure');
        this.blockForm                  = $('iwd_om_product_composite_configure_form');
        this.blockFormFields            = $('iwd_om_product_composite_configure_form_fields');
        this.blockFormAdd               = $('iwd_om_product_composite_configure_form_additional');
        this.blockFormConfirmed         = $('iwd_om_product_composite_configure_form_confirmed');
        this.blockConfirmed             = $('iwd_om_product_composite_configure_confirmed');
        this.blockIFrame                = $('iwd_om_product_composite_configure_iframe');
        this.blockCancelBtn             = $('iwd_om_product_composite_configure_form_cancel');
        this.blockMask                  = $('iwd_om_popup-window-mask');
        this.blockMsg                   = $('iwd_om_product_composite_configure_messages');
    ...
    */
    ...
    onConfirmBtn: function() {
        if (productCompositeConfigureForm.validate()) {
            ...
            ProductConfigureIWDOM._processFieldsData('item_confirm');
            ProductConfigureIWDOM._processFieldsData('current_confirmed_to_form');

            IWD.OrderManager.OrderedItems.editOrderedItemsOptions(this.current.itemId);
    ...
    _processFieldsData: function(method) {
        ...
        this.confirmedCurrentId = this._getConfirmedBlockId(this.current.listType, this.current.itemId);
...
Event.observe(window, 'load',  function() {
    ProductConfigureIWDOM = new ProductConfigureIWDOM();
});
