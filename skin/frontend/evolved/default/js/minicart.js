            ...
            $j.ajax({
                ...
                if (result.success) {
                    ...
                    if(jQuery('.shoppingcart .cartgo')){
                          jQuery('.shoppingcart .cartgo').replaceWith('<a class="cartgo" href="/checkout/cart">' + result.qty + '</a>');
                     }
                    if(jQuery('.skip-content .minicart-wrapper')){
                          jQuery('.skip-content .minicart-wrapper').replaceWith(result.content);
                        }
