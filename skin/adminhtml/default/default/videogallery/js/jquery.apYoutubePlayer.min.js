...
(function($) {
	 ...
	 function ap_YoutubePlayer(data){
		 ...
		 if(!_youtubeChromeless){
			 no_relVid = '?rel=0';
			 if(isChrome && !isOpera){
				 videoIFrameSrc = 'http://www.youtube.com/embed/' + data.mediaPath + no_relVid + youtubeApi + theme;//zindexfix causes thumb preview in chrome weird render lag (we need zindexfix in other browsers to show content over youtube video)
			 }else if(isIE){//zindexfix causes problems in ie10?, but we need it because of playlist selector
